...
if($_REQUEST['sub'])
{
$sel=mysqli_query($link,"select id from register where id='$id' ");
$arr=mysqli_fetch_array($sel);

if($arr['id']!=$id)
  {
   if(mysqli_query($link,"insert into register values('$title','$fname','$lname','$gen','$id','$pass','$phone','$add','$city','$coun','$dob')"))
	   {

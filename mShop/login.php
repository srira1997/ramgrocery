...
$id=$_REQUEST['t1'];
$pass=$_REQUEST['p1'];
   $sel=mysqli_query($link,"select id,pass from register where   id='$id' AND pass='$pass'");
...
?>
<html>
<div><br/><center><h2><font face="Lucida Handwriting" size="+1" color="red">Login your Account</font></h2></center></div>
<div>
<div style="background:pink;width:25%;float:right">
<img src="usepics/7.jpg">
</div>

<br><br>
<div style="width:70%;float:right" align="center" >
<center><fieldset style="background:blue;width:50%">
<br><br>
